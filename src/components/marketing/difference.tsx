...
import { SubGen_FEATURES, OTHER_TOOLS } from '@/constants/difference';
        ...
        <section id="difference" className="w-full py-16 lg:py-24 relative overflow-hidden">
            <Wrapper>
                <div className="flex flex-col items-center text-center">
                    ...
                    >
                        Most subtitle tools translate instead of transliterate
                    </motion.p>
                </div>
                ...
                <div className="relative max-w-5xl mx-auto mt-12">
                    ...
                    >
                        ...
                        <div className="flex flex-col gap-y-6">
                            ...
                            <div className="space-y-3 relative">
                                {SubGen_FEATURES.map((item, index) => (
                                    <motion.div
                                        key={index}
                                        initial={{ opacity: 0 }}
